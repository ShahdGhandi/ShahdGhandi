...
# 👩🏻‍💻 Shahd Ghandi  
### .NET Full Stack Developer | OOP Specialist | Problem Solver 💙
...
- 🗄️ Passionate about **Database Design & SQL**
- 🏗️ Learning **Design Patterns & Clean Architecture**
...
```csharp
public class Shahd : Developer
{
    public string Track = "Full Stack .NET";
